                ...
                <div class="col-lg-4">
                    <form action="" method="post" role="form" class="php-email-form">
                        <div class="form-group">
                            <input type="email" class="form-control" name="email" id="email" placeholder="Alamat Email..." data-rule="email"/>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control" name="password" id="password" placeholder="Password..." data-rule="password"/>
                        </div>                        
                        <a type="submit" class="cta-btn scrollto" href="#">MASUK</a>
                    </form>
                    <div class="mt-5">
                        <p>Belum Punya Akun? <b><u><a style="color:white" href="register.php">Buat Akun</a></u></b></p>
                    </div>
                </div>
            </center>  
