                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <blockquote class="m-b-25">
                                <p>Anda Sudah Melakukan Pengisisan Formulir Pendaftaran</p>
                            </blockquote>
                            <blockquote>
                                <p>Untuk Langkah Selanjutnya Silahakan Upload Berkas Pendaftaran</p>
                                <footer>Silahkan menuju halaman pada <cite title="Source Title" class="col-cyan">Menu Berkas Pendaftaran</cite></footer>
                            </blockquote>
