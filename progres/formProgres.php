...
if (isset($_POST['addMandiri']))
{
    ...
    mysqli_stmt_bind_param($stmtmandiri, 'sssssssssssssssssssssssssssssssssssssssssss',
                            $formJalur,
                            $formProdi,
                            $formKelas,
                            $formNisn,
...
{       
    ...
    mysqli_stmt_bind_param($stmtbeasiswa,'ssssssssssssssssssssssssssssssssssssssssssss',                            
                            $formJalur,
                            $formBeasiswa,
                            $formProdi,
                            $formKelas,
