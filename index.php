...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <a href="#" class="logo mr-auto"><img src="assets/hm/img/logo.png" alt=""></a>
        ...
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <ol class="carousel-indicators" id="hero-carousel-indicators"></ol>
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <!-- Slide 1 -->
                    <div class="carousel-item active" style="background-image: url(assets/hm/img/slide/slide-1.jpg)">
                    </div>

                    <!-- Slide 2 -->
                    <div class="carousel-item" style="background-image: url(assets/hm/img/slide/slide-2.jpg)">  
                    </div>

                    <!-- Slide 3 -->
                    <div class="carousel-item" style="background-image: url(assets/hm/img/slide/slide-3.jpg)">  
                    </div>        
    ...
    <main id="main">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-lg-6" data-aos="fade-right">
                        <img src="assets/hm/img/about.png" class="img-fluid" alt="">
                    </div>
                    <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left">
                        <h3>Visi</h3>
                        <p class="font-italic">
                        Menjadi Politeknik yang Berdaya Saing Global, Professional dan beraqidah Ahlus Sunnah Wal Jama’ah.
                        </p>            
                        <h3>Misi</h3>
                        <ol>
        ...
        <section id="beasiswa" class="counts">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Beasiswa Kuliah</h2>
                    <br>
                    <p>
                    Bagi Lulusan SMA/MA/SMK yang masih pusing cari kuliah/kerja? Yuk gabung bersama kami di POLIBANG JEPARA
                    <b><h6>buruan ambil <u>KESEMPATAN EMAS</u> ini</h6></b>
                    </p>
                </div>
        ...
        <section id="panduan" class="featured-services">
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            <img src="assets/hm/img/panduan/tahap1.png" class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-3 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            <img src="assets/hm/img/panduan/tahap2.png" class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                            <img src="assets/hm/img/panduan/tahap3.png" class="img-fluid" alt="">
                        </div>
                    </div>        
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
                            <img src="assets/hm/img/panduan/tahap4.png" class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-3 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="200">
                            <img src="assets/hm/img/panduan/tahap5.png" class="img-fluid" alt="">
                        </div>
                    </div>

                    <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
                        <div class="icon-box" data-aos="fade-up" data-aos-delay="300">
                            <img src="assets/hm/img/panduan/tahap6.png" class="img-fluid" alt="">
                        </div>
                    </div>      
                </div>

            </div>
        </section><!-- End  Panduan Pendaftaran -->        
                    ...
                    <div class="col-lg-8">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab-1">
                                ...
                                <img src="assets/hm/img/rpl.jpg" alt="" class="img-fluid">
                            ...
                            <div class="tab-pane" id="tab-2">
                                ...
                                <img src="assets/hm/img/administrasi.jpg" alt="" class="img-fluid">
                            ...
                            <div class="tab-pane" id="tab-3">
                                ...
                                <img src="assets/hm/img/akuntansi.jpg" alt="" class="img-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="100">
                            <div class="member-img">
                                <img src="assets/hm/img/slide/slide-1.jpg" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="member-img">
                                <img src="assets/hm/img/slide/slide-8.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Aula</h4>
                                <span></span>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="300">
                            <div class="member-img">
                                <img src="assets/hm/img/slide/slide-5.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Unit Bisnis</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="400">
                            <div class="member-img">
                                <img src="assets/hm/img/slide/slide-6.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="500">
                            <div class="member-img">
                                <img src="assets/hm/img/slide/slide-7.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Lab Bisnis</h4>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="member" data-aos="fade-up" data-aos-delay="600">
                            <div class="member-img">
                                <img src="assets/hm/img/slide/slide-4.jpg" class="img-fluid" alt="">
                            </div>
                            <div class="member-info">
                                <h4>Homestay</h4>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="owl-carousel testimonials-carousel" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="testimonial-item">
                        ...
                        <img src="assets/hm/img/testimonials/wikan.jpg" class="testimonial-img" alt="">
                    ...
                    <div class="testimonial-item">
                        ...
                        <img src="assets/hm/img/testimonials/andang.jpg" class="testimonial-img" alt="">
        ...
        <section id="galeri" class="gallery">
            <div class="container" data-aos="fade-up">
                ...
                <div class="owl-carousel gallery-carousel" data-aos="fade-up" data-aos-delay="100">
                    <a href="assets/hm/img/gallery/gallery-1.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-1.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-2.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-2.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-3.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-3.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-4.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-4.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-5.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-5.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-6.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-6.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-7.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-7.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-8.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-8.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-9.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-9.jpg" alt=""></a>
                    <a href="assets/hm/img/gallery/gallery-10.jpg" class="venobox" data-gall="gallery-carousel"><img src="assets/hm/img/gallery/gallery-10.jpg" alt=""></a>
                </div>
